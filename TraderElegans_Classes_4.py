...
model = Sequential()
model.add(LSTM(units = 12 , return_sequences=True, batch_input_shape=(len(train_x),Constants.LOOKBACK, Constants.FEATURES), stateful=False, activation='relu', kernel_initializer='random_uniform'))
